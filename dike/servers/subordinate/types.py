...
class Endpoint(Enum):
    ...
    UPDATE_MALWARE_LABELS = ("update_malware_labels", True)
    ...
    CREATE_RETRAINING = ("create_retraining", False)
...
class Employment(Enum):
    """Class encapsulating all states of employment.

    The employment is produced by time-consuming tasks of the subordinate
    server.
    """
